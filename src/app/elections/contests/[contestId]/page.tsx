...
export default async function ContestPage({ params, searchParams }: {
  ...
  if (!Number.isSafeInteger(offset) || offset < 0) return <main id="main-content"><ElectionContest result={{ status: "missing" }} /></main>;
  ...
  return <main id="main-content"><ElectionContest result={result} /></main>;
}
