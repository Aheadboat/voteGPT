...
R0 — Durable Project Contract, F1 — Development and Test Foundation, F2 — Identity and Public Shell, and F3 — Residence Resolution Preview are complete. R1 — Concurrent Roadmap Delivery Contract is active at RED on `codex/r1-roadmap-coordinator-contract` while final activation-authority gaps are corrected; F4 and every later roadmap item remain TODO pending separate authorization.
