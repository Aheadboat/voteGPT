...
Start: [database schema](src/db/schema.ts), [database access](src/db/index.ts). Adjacent: [latest migration](drizzle/0003_federal_official_cache.sql), [database tests](src/db/index.test.ts). Check: `npm.cmd test -- src/db/index.test.ts`.
